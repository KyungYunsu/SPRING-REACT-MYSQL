    ...
    return (
      <div id='board-detail-top'>
        <div className='board-detail-top-header'>
          ...
          <div className='board-detail-top-sub-box'>
            <div className='board-detail-write-info-box'>
              <div className='board-detail-sriter-profile-image' style={{backgroundImage: `url(${defaultProfileImage})`}}></div>
        ...
        <div className='board-detail-top-main'>
          ...
          <img className='board-detail-main-image' src='https://picsum.photos/seed/picsum/200/300.jpg' />
        </div>
      </div>
    )
  }
